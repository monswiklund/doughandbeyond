...
## Surface Topology & Components
- **Hero**: Glöd- och rökeffekt med 3D-vinklat produktkort.
- **Crafting Demo**: Interaktiv visuell skiva för deghydrering, sås och toppingar.
- **Frozen Showcase**: 4-stegs hantverksprocess från 485°C ugn till 4 min i hemmaugnen.
- **Retailer Finder**: Regionfiltrering och sökbar butikslista över hela Sverige.
- **Order Drawer**: Glasmorfisk slide-over med direkt order-API i TypeScript.
